...
internal static class TaskExtensions
{
	...
	public static void Forget(this ValueTask valueTask) { _ = valueTask.Preserve(); }

	public static void Forget<TResult>(this ValueTask<TResult> valueTask)  { _ = valueTask.Preserve(); }
