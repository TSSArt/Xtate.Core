...
{
	private const string InitialChildTransitionIsHonored = """
	...
	private const string InitialTransitionActionsRunInDocumentOrder = """
	...
	private const string InitialTransitionCanEnterNestedDescendant = """
																	 <scxml xmlns="http://www.w3.org/2005/07/scxml" version="1.0" initial="outer">
																	   <state id="outer">
																	 	<initial>
	...
	private const string FinalDoneDataWithExpression = """
