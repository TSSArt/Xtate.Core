...
public class BasicMachines : IScxmlTestSource
{
	...
	/// </summary>
	private const string SingleFinalState = """
	...
	/// </summary>
	private const string TwoStatesEventlessTransition = """
	...
	/// </summary>
	private const string ThreeSequentialStates = """
												 <scxml xmlns="http://www.w3.org/2005/07/scxml" version="1.0" initial="s1">
												   <state id="s1">
	...
	/// </summary>
	private const string OnEntryOnExit = """
										 <scxml xmlns="http://www.w3.org/2005/07/scxml" version="1.0" initial="s1">
										   <state id="s1">
										 	<onentry>
	...
	/// </summary>
	private const string FinalStateWithDoneData = """
												  <scxml xmlns="http://www.w3.org/2005/07/scxml" version="1.0" initial="done">
												    <final id="done">
												  	<donedata>
