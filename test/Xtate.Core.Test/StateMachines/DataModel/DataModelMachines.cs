...
namespace Xtate.Core.Test.StateMachines.DataModel;
...
public class DataModelMachines : IScxmlTestSource
{
	...
	///     scripting support.
	/// </summary>
	private const string ExplicitNullDataModel = """
	...
	/// </summary>
	private const string FinalStateWithStringContent = """
	...
	/// </summary>
	private const string NamedInitialState = """
	...
	/// </summary>
	private const string ExplicitInitialSelectsFinalState = """
