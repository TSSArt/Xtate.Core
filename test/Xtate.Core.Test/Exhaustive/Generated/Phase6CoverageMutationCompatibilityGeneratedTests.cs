	...
	[
		[
			new PhaseSixGateCase(
				CaseId: "PHASE6-NORMATIVE-SCXML-CASE-001", ExpectedDecision: "pass complete ledger; fail missing SCXML-PARSE-001",
				Forbidden: "No aggregate count may mask missing SCXML evidence.")
		],
		[
			new PhaseSixGateCase(
				CaseId: "PHASE6-NORMATIVE-XPATH-CASE-001", ExpectedDecision: "pass complete ledger; fail missing XPATH-ASSIGN-010",
		...
		[
			new PhaseSixGateCase(
				CaseId: "PHASE6-CRITICAL-MUTATION-CASE-001", ExpectedDecision: "pass all critical mutants killed; fail one survivor",
				Forbidden: "No aggregate mutation score may mask a critical survivor.")
		],
		...
		[
			new PhaseSixGateCase(
				CaseId: "PHASE6-COMPATIBILITY-GATE-CASE-001", ExpectedDecision: "fail untriaged Windows authority divergence", Forbidden: "No untriaged authority divergence may pass.")
		]
	];
