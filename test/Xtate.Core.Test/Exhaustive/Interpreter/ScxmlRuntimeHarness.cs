...
{
	public static ValueTask<DataModelValue> ExecuteAsync(string scxml) => ExecuteAsync(scxml, null, null, null);

	public static ValueTask<DataModelValue> ExecuteAsync(string scxml, INotifyStateChanged? notification) => ExecuteAsync(scxml, notification, null, null);

	public static async ValueTask<DataModelValue> ExecuteAsync(string scxml, INotifyStateChanged? notification, ILogger<StateMachineInterpreter>? logger, ILogger<ILogController>? actionLogger = null)
	{
	...
	public static ValueTask<DataModelValue> ExecuteWithExternalEventsAsync(string scxml, params string[] eventNames) => ExecuteWithExternalEventsAsync(scxml, null, eventNames);
