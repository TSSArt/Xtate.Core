...
internal static class PhaseOneCases
{
	...
	[
		new(CaseId: "SCXML-PARSE-001-CASE-101", RequirementId: "SCXML-PARSE-001"), new(CaseId: "SCXML-PARSE-002-CASE-101", RequirementId: "SCXML-PARSE-002"),
		new(CaseId: "SCXML-PARSE-003-CASE-101", RequirementId: "SCXML-PARSE-003"), new(CaseId: "SCXML-PARSE-004-CASE-101", RequirementId: "SCXML-PARSE-004"),
		new(CaseId: "SCXML-PARSE-005-CASE-101", RequirementId: "SCXML-PARSE-005"),
		new(CaseId: "SCXML-PARSE-006-CASE-101", RequirementId: "SCXML-PARSE-006"), new(CaseId: "SCXML-PARSE-007-CASE-101", RequirementId: "SCXML-PARSE-007"),
		new(CaseId: "SCXML-PARSE-008-CASE-101", RequirementId: "SCXML-PARSE-008"), new(CaseId: "SCXML-PARSE-009-CASE-101", RequirementId: "SCXML-PARSE-009"),
		new(CaseId: "SCXML-PARSE-010-CASE-101", RequirementId: "SCXML-PARSE-010"),
		new(CaseId: "SCXML-PARSE-011-CASE-101", RequirementId: "SCXML-PARSE-011"), new(CaseId: "SCXML-PARSE-012-CASE-101", RequirementId: "SCXML-PARSE-012"),
		new(CaseId: "SCXML-PARSE-013-CASE-101", RequirementId: "SCXML-PARSE-013"), new(CaseId: "SCXML-PARSE-014-CASE-101", RequirementId: "SCXML-PARSE-014"),
		new(CaseId: "SCXML-PARSE-015-CASE-101", RequirementId: "SCXML-PARSE-015"),
		new(CaseId: "SCXML-PARSE-016-CASE-101", RequirementId: "SCXML-PARSE-016"), new(CaseId: "SCXML-PARSE-017-CASE-101", RequirementId: "SCXML-PARSE-017"),
		new(CaseId: "SCXML-PARSE-018-CASE-101", RequirementId: "SCXML-PARSE-018"), new(CaseId: "SCXML-PARSE-019-CASE-101", RequirementId: "SCXML-PARSE-019"),
		new(CaseId: "SCXML-PARSE-020-CASE-101", RequirementId: "SCXML-PARSE-020"),
		new(CaseId: "SCXML-PARSE-021-CASE-101", RequirementId: "SCXML-PARSE-021"), new(CaseId: "SCXML-PARSE-022-CASE-101", RequirementId: "SCXML-PARSE-022"),
		new(CaseId: "SCXML-PARSE-023-CASE-101", RequirementId: "SCXML-PARSE-023"), new(CaseId: "SCXML-PARSE-024-CASE-101", RequirementId: "SCXML-PARSE-024"),
		new(CaseId: "SCXML-PARSE-025-CASE-101", RequirementId: "SCXML-PARSE-025"),
		new(CaseId: "SCXML-XINC-001-CASE-101", RequirementId: "SCXML-XINC-001"), new(CaseId: "SCXML-XINC-002-CASE-101", RequirementId: "SCXML-XINC-002"),
		new(CaseId: "SCXML-XINC-003-CASE-101", RequirementId: "SCXML-XINC-003"), new(CaseId: "SCXML-XINC-004-CASE-101", RequirementId: "SCXML-XINC-004"),
		new(CaseId: "SCXML-XINC-005-CASE-101", RequirementId: "SCXML-XINC-005"), new(CaseId: "SCXML-XINC-006-CASE-101", RequirementId: "SCXML-XINC-006"),
		new(CaseId: "SCXML-XINC-007-CASE-101", RequirementId: "SCXML-XINC-007"), new(CaseId: "SCXML-XINC-008-CASE-101", RequirementId: "SCXML-XINC-008"),
		new(CaseId: "SCXML-VALID-001-CASE-101", RequirementId: "SCXML-VALID-001"), new(CaseId: "SCXML-VALID-002-CASE-101", RequirementId: "SCXML-VALID-002"),
		new(CaseId: "SCXML-VALID-003-CASE-101", RequirementId: "SCXML-VALID-003"), new(CaseId: "SCXML-VALID-004-CASE-101", RequirementId: "SCXML-VALID-004"),
		new(CaseId: "SCXML-VALID-005-CASE-101", RequirementId: "SCXML-VALID-005"), new(CaseId: "SCXML-VALID-006-CASE-101", RequirementId: "SCXML-VALID-006"),
		new(CaseId: "SCXML-VALID-007-CASE-101", RequirementId: "SCXML-VALID-007"), new(CaseId: "SCXML-VALID-008-CASE-101", RequirementId: "SCXML-VALID-008"),
		new(CaseId: "SCXML-VALID-009-CASE-101", RequirementId: "SCXML-VALID-009"), new(CaseId: "SCXML-VALID-010-CASE-101", RequirementId: "SCXML-VALID-010"),
		new(CaseId: "SCXML-VALID-011-CASE-101", RequirementId: "SCXML-VALID-011"), new(CaseId: "SCXML-VALID-012-CASE-101", RequirementId: "SCXML-VALID-012"),
		new(CaseId: "SCXML-SER-001-CASE-101", RequirementId: "SCXML-SER-001"), new(CaseId: "SCXML-SER-002-CASE-101", RequirementId: "SCXML-SER-002"),
		new(CaseId: "SCXML-SER-003-CASE-101", RequirementId: "SCXML-SER-003"), new(CaseId: "SCXML-SER-004-CASE-101", RequirementId: "SCXML-SER-004"),
		new(CaseId: "SCXML-SER-005-CASE-101", RequirementId: "SCXML-SER-005"), new(CaseId: "SCXML-SER-006-CASE-101", RequirementId: "SCXML-SER-006")
	];

	public static IEnumerable<object[]> For(string family) => All.Where(@case => @case.RequirementId.StartsWith(family, StringComparison.Ordinal)).Select(@case => new object[] { @case });
}
