...
{
	public required Func<object?, StateMachineBuilder> StateMachineBuilderFactory { private get; [UsedImplicitly] init; }
	public required Func<object?, StateBuilder>        StateBuilderFactory        { private get; [UsedImplicitly] init; }
	public required Func<object?, ParallelBuilder>     ParallelBuilderFactory     { private get; [UsedImplicitly] init; }
	public required Func<object?, HistoryBuilder>      HistoryBuilderFactory      { private get; [UsedImplicitly] init; }
	public required Func<object?, InitialBuilder>      InitialBuilderFactory      { private get; [UsedImplicitly] init; }
	public required Func<object?, FinalBuilder>        FinalBuilderFactory        { private get; [UsedImplicitly] init; }
	public required Func<object?, TransitionBuilder>   TransitionBuilderFactory   { private get; [UsedImplicitly] init; }
	public required Func<object?, LogBuilder>          LogBuilderFactory          { private get; [UsedImplicitly] init; }
	public required Func<object?, SendBuilder>         SendBuilderFactory         { private get; [UsedImplicitly] init; }
	public required Func<object?, ParamBuilder>        ParamBuilderFactory        { private get; [UsedImplicitly] init; }
	public required Func<object?, ContentBuilder>      ContentBuilderFactory      { private get; [UsedImplicitly] init; }
	public required Func<object?, OnEntryBuilder>      OnEntryBuilderFactory      { private get; [UsedImplicitly] init; }
	public required Func<object?, OnExitBuilder>       OnExitBuilderFactory       { private get; [UsedImplicitly] init; }
	public required Func<object?, InvokeBuilder>       InvokeBuilderFactory       { private get; [UsedImplicitly] init; }
	public required Func<object?, FinalizeBuilder>     FinalizeBuilderFactory     { private get; [UsedImplicitly] init; }
	public required Func<object?, ScriptBuilder>       ScriptBuilderFactory       { private get; [UsedImplicitly] init; }
	public required Func<object?, CustomActionBuilder> CustomActionBuilderFactory { private get; [UsedImplicitly] init; }
	public required Func<object?, DataModelBuilder>    DataModelBuilderFactory    { private get; [UsedImplicitly] init; }
	public required Func<object?, DataBuilder>         DataBuilderFactory         { private get; [UsedImplicitly] init; }
	public required Func<object?, DoneDataBuilder>     DoneDataBuilderFactory     { private get; [UsedImplicitly] init; }
	public required Func<object?, AssignBuilder>       AssignBuilderFactory       { private get; [UsedImplicitly] init; }
	public required Func<object?, RaiseBuilder>        RaiseBuilderFactory        { private get; [UsedImplicitly] init; }
	public required Func<object?, CancelBuilder>       CancelBuilderFactory       { private get; [UsedImplicitly] init; }
	public required Func<object?, ForEachBuilder>      ForEachBuilderFactory      { private get; [UsedImplicitly] init; }
	public required Func<object?, IfBuilder>           IfBuilderFactory           { private get; [UsedImplicitly] init; }
	public required Func<object?, ElseBuilder>         ElseBuilderFactory         { private get; [UsedImplicitly] init; }
	public required Func<object?, ElseIfBuilder>       ElseIfBuilderFactory       { private get; [UsedImplicitly] init; }
